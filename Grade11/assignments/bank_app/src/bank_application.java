...
class Accounts {
	...
	void Show_Account_Holder_Info() {
		try {
			...
			e.printStackTrace();
			bank_application.support("json_error");
		}
	}
	...
	void UpdateBal() {
		...
		try (FileWriter filewriter = new FileWriter(File_Loc)) {
			...
			e.printStackTrace();
			bank_application.support("write_error");
		}
	}
}
...
public class bank_application extends Accounts {
		...
		do {
			...
			switch (InputFromUser) {
				case 1: // for show Account Info
					...
					break;
				case 2: // for Deposit
					System.out.print("Enter an amount you want to deposite = ");
	...
	static void clear() { // function to clear terminal
	...
	// if program throws and error it will display error origin.
